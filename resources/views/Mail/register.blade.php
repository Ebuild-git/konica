...
<head>
    ...
    <title>Bienvenue chez YOUTHKEY</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <h1>Bienvenue chez YOUTHKEY !</h1>
            <p>Bonjour {{ $user->nom }} ,</p>
            <p>Nous sommes ravis de vous compter parmi nos nouveaux membres. Chez YOUTHKEY, nous nous engageons à vous fournir des produits cosmétique 100 % bio  pour répondre à tous vos besoins.</p>
        ...
        <div class="footer">
            <p>&copy; 2024 YOUTHKEY. Tous droits réservés.</p>
        </div>
    </div>
</body>
</html>
