...
{{-- 
                    ...
                    <li class="my-account">
                        ...
                        <div class="my-account-dropdown">
                            ...
                            @else
                            <div class="login-btn">
                                <a href="{{ url('login') }}" class="axil-btn btn-bg-primary2">Connexion</a>
                            </div>
            ...
            <div class="card-header">
                <form role="search" action="{{ url('search') }}" method="get">
                    <div class="input-group">
                        <input value="{{ $nom ?? '' }}" class="form-control" id="search" type="search" name="search" placeholder="Rechercher produit....">
    ...
    <div class="cart-dropdown" id="cart-dropdown">
        <div class="cart-content-wrap">
            <div class="cart-header">
                <h2 class="header-title">Mon panier</h2>
            ...
            <div class="cart-footer">
                ...
                <div class="group-btn">
                    <a href="{{ route('cart') }}" class="axil-btn btn-bg-primary2 viewcart-btn">Voir panier</a>
                    <a href="{{ url('/commander') }}" class="axil-btn btn-bg-secondary2 checkout-btn">Commander</a>
                </div>
            </div>
        </div>
    </div>
