                    ...
                    <div class="col-xl-3 col-md-8">
                        <div class="sidebar-area">
                            {{-- <div class="shop-widget mb-30">
                                <h5 class="shop-widget-title">Filtre par prix</h5>
                            ...
                            <div class="shop-widget mb-30">
                                <div class="check-box-item">
                                    ...
                                    <ul class="shop-item">
                                        <li>
                                            <a href="/shop">Tous les produits</a></li>
                        ...
                        {{--     <div class="shop-widget mb-30">
                             ...
                             <div class="shop-widget">
                                ...
                                @endphp
                                <h5 class="shop-widget-title">Les 5 dernières publications</h5>
                                @foreach ($lastproduits as $produit) 
                                <div class="top-product-widget mb-20">
                                    <div class="top-product-img">
                                        <a href="{{ route('details-produits', ['id' => $produit->id, 'slug' => Str::slug(Str::limit($produit->nom, 10))]) }}"><img  height="100" width="100" src="{{ Storage::url($produit->photo) }}"
                                                alt=""></a>
                                    </div>
                                    <div class="top-product-content">
                                        <h6><a href="{{ route('details-produits', ['id' => $produit->id, 'slug' => Str::slug(Str::limit($produit->nom, 10))]) }}">{{ $produit->nom ?? ' ' }}</a></h6>
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="all-products list-grid-product-wrap">
                            <div class="row gy-4 mb-80 ">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-4 col-sm-6 item">
                                        ...
                                        <div class="tab-content" id="view-tabContent">
                                            <div class="tab-pane fade show active" id="view-pills-img1" role="tabpanel">
                                                <div class="shop-details-tab-img">
                                                    <img src="assets/img/inner-page/shop-details-tab-img1.png"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="view-pills-img2" role="tabpanel">
                                                <div class="shop-details-tab-img">
                                                    <img src="assets/img/inner-page/shop-details-tab-img2.png"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="view-pills-img3" role="tabpanel">
                                                <div class="shop-details-tab-img">
                                                    <img src="assets/img/inner-page/shop-details-tab-img3.png"
                                                        alt="">
                                                </div>
                                            </div>
                                            <div class="tab-pane fade" id="view-pills-img4" role="tabpanel">
                                                <div class="shop-details-tab-img">
                                                    <img src="assets/img/inner-page/shop-details-tab-img4.png"
                                                        alt="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="nav nav-pills" id="view-tab" role="tablist"
                                            aria-orientation="vertical">
                                            <button class="nav-link active" id="view-pills-img1-tab"
                                                data-bs-toggle="pill" data-bs-target="#view-pills-img1" type="button"
                                    ...
                                    <div class="shop-details-content">
                                        ...
                                        <ul class="product-shipping-delivers">
                                            ...
                                            <li class="product-delivers">
                                                ...
                                                <p>Delivers in: 3-7 Working Days <a href="#">Shipping &amp;
                                                        Return</a></p>
                                            </li>
                                        </ul>
