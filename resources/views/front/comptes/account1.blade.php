                        ...
                        <div class="dashboard-left">
                            <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist"
                                ...
                                <button class="nav-link nav-btn-style mx-auto" id="v-pills-order-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="v-pills-order" aria-selected="true"><svg width="20" height="20"
                                ...
                                <a class="nav-link nav-btn-style mx-auto"  role="tab"  href="{{ route('logout') }}"
                                    ...
                                    <div class="table-wrapper">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="Product Details">    {{ $favo->created_at }}</td>
                                                <td data-label="price">    {{ $favo->produit->getPrice() }} DT</td>
                                                <td data-label="Status" class="text-green">    @if ($favo->produit->stock > 0)
